...
class MessageBag:
    ...
    DATA_NOT_ACTIVATED = _(
        "{data} has not been activated or one of it's properties has not been provided"
    )
    ...
    SUCCESSFUL_DATA_VALIDATION = _(
        "{data} has been successfully validated"
    )  # todo ::: DATA_VALIDATION_SUCCESS
